...
OpenModelica as well as the Makefile set up to compile to this code to
...
Modelica.Electrical.Analog.Examples. All the calculations are done on
the client.

The gui for that page was done using
...
various licenses. The Makefiles and other files that I made are
granted to the public domain (or alternatively under the MIT license).
